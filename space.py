...
icono = pygame.image.load("ovºni.png")
pygame.display.set_icon(icono)
fondo = pygame.image.load("space_medida.jpg")

#agregar musica
mixer.music.load("dead_wrong.mp3")
...
for e in range(cantidad_enemigos):
    img_enemigo.append(pygame.image.load("jefe-final.png"))
...
while run:
    ...
    for evento in pygame.event.get():
        ...
        if evento.type == pygame.KEYDOWN:
            ...
            if evento.key == pygame.K_SPACE:
                sonido_bala = mixer.Sound("sonido_bala.mp3")
                sonido_bala.play()
    ...
    #mantener dentro de bordes enemigo
        ...
        if colision:
            explocion = mixer.Sound("explocion.mp3")
            explocion.play()
            bala_y = 500
            bala_visible = False
            puntaje += 1
